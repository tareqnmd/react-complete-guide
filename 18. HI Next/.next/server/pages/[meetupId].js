...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://tareqatoffice:667024@Office@cluster0.kunopfj.mongodb.net/?retryWrites=true&w=majority');
  const db = client.db();
